  ...
  return (
    <div className="space-y-2 text-left">
      ...
      <div className="flex items-stretch bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl">
        ...
        {/* Passengers */}
        <div className="relative shrink-0" ref={seatRef}>
          <button onClick={() => setSeatOpen(v => !v)}
            ...
            <Users className="w-3.5 h-3.5 text-orange-300 shrink-0" />
            <div>
              <div className={micro}>Passengers</div>
              <div className="text-white text-sm font-semibold whitespace-nowrap">{seatLabel}</div>
            </div>
        ...
        {/* Search */}
        <button onClick={go}
          className="px-5 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold text-sm hover:opacity-90 transition-all flex items-center gap-2 shrink-0 rounded-r-2xl">
